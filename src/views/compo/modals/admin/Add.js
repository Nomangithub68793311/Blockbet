                ...
                <Modal.Body>
                    ...
                    <Form onSubmit={(e) => this.props.submitForm(this.props.fields, e)}>
                        <div className="row">
                            ...
                            <div className="col-md-12">
                                <div className="mt-3">
                                    <Button variant={'link'} className={'custom-cta primary cta-large full-opacity'} type={'submit'} block>Add Admin</Button>
                                </div>
                            </div>
...
const dispatchToProps = dispatch => ({
    ...
    submitForm: (values, event) => dispatch(submitForm('add-admin', values, event, response => {
        if(response.status_code === 200) {
            dispatch(closeAddAdminModalIfOpened())
            dispatch(getAdmins())
        }
    }))
})

export default connect(stateToProps, dispatchToProps)(AddAdmin)
